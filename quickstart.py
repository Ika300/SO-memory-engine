...
try:
    ...
    if exc.name in {"so_memory_engine", "so_memory_kernel"}:
        ...
        print()
        print("This installs SO Memory Kernel from GitHub.")
        print("If direct dependency installation fails, see docs/INSTALLATION.md for the manual sibling-repository setup.")
        print()
...
def main() -> None:
    ...
    print("===========================")
    print()
    print("This demo uses curated EngineMemory examples so the Engine behavior is visible immediately.")
